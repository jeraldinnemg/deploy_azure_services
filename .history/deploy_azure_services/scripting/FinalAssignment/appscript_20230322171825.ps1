...
function Validate-ResourceName {
  ...
  # Improvement: only "STA" should be entered in lowercase
  param(
...
function Create-AllResources{
    param(
        $location = "eastus"
            ...
            -Subnet $newSubnet
            #validar que se haya creado vnt
            ...
            #validar que se haya creado sbn
            if(Validate-ResourceExists -RsgOrRsc "rsc" -ResourceName $VirtualNetworkName){
            ...
            #Create
                New-AzStorageAccount `
                    ...
                    -ResourceGroupName $ResourceGroupName `
                    -Location $location
            #validar que se haya creado sta
            ...
            #validar que se haya creado azf
            ...
            #Create
                New-AzAppServicePlan  `
                    ...
                    -ResourceGroupName $ResourceGroupName `
                    -Location $location
            #validar que se haya creado asp
